 ...
 #--- If Statements to call functions, part of menu().
  if menuAsk not in acceptableMenuOptions: # If the input for menuAsk isn't a number between 1 and 5 (acceptableMenuOptions), the follwing code is exectuted.
   ...
   logging.debug('Determining menu option selected.')
    ...
    logoutConfirm = input(Fore.GREEN + 'Confirm -  ' + Style.RESET_ALL + 'Are you sure you want to logout? (Press enter, anything else will return to menu. )\n')
...
def createMessage():
  ...
  if hiddenAsk in acceptableMenu:
      print(Style.BRIGHT + Fore.GREEN + 'Notification: ' + Style.RESET_ALL + 'Returning to menu, standby.')
      time.sleep(2)
      os.system('cls')
      print(launchScreen)
      menu()
...
def findMessages():
  ...
  elif hiddenAsk in acceptableMenu:
      print()
      print(Style.BRIGHT + Fore.GREEN + 'Notification: ' + Style.RESET_ALL + 'Returning to menu, standby.')
      time.sleep(2)
      os.system('cls')
